...
/*below we are using lazy loading because we want only those form to be rendered which is currently in use ,if we does not use it then all the forms will be rendered unnecessarily*/
